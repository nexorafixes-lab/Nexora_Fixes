  ...
  const created = await airtableRequest(endpoint, {
    ...
    body: JSON.stringify({
      ...
      records: [{
        fields: {
          "Lead ID": testId,
    Name: "Nexora Fixes Connection Test",
    Email: "connection-test@nexorafixes.com",
          Phone: "+1 555 010 9999",
          Service: "Other",
          Status: "Needs review",
    Summary: "Temporary record created by chatbot/scripts/test-airtable-connection.mjs",
        },
      }],
      typecast: true,
    }),
