...
import { body_font, dm_mono, heading_font } from "./lib/fonts";
import DotField from "@/components/DotField";
import { cn } from "@/lib/utils";

export const metadata: Metadata = {
  title: "404 | Nexora Fixes",
...
export default function GlobalNotFound() {
  return (
    <html lang="en" className={cn(dm_mono.variable, "font-sans")}>
      <body
        className={`${body_font.variable} ${heading_font.variable} ${dm_mono.variable} antialiased bg-black`}
      >
        <main className="relative isolate grid min-h-screen place-items-center overflow-hidden bg-background px-4 py-20 text-white">
          ...
          <section className="container relative z-10 mx-auto grid max-w-4xl justify-items-center text-center">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-text-2 md:text-lg">
              The page you are looking for does not exist, moved, or is
              currently unavailable. Let&apos;s get you back to Nexora Fixes.
            </p>
